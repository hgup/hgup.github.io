...
Consider the market for a single commodity, the demand of commodity comes from various consumers. _Each_ consumer will decide his demand $D_i\  (i=1,\dots n)$ according to his utility maximizing condition. So if $P$ is the **price** of the commodity. Then demand, $D_i = D_i(P)$ is a function of price. So, **aggregate demand** is a _sum of all the individual demands_.
